...
from mysql_db_netbar import DB
...
datas = {
    ...
    'ap_group':[
        {'id':10,'name':'interAP','remarks':'add successfully','ap_num':1,'store_id':103,'merchant_id':102,'config_version':1,'portal_id':1,'ssid':'hliussid'}
    ],
}
